...
The table below summarizes intakes, screening decision and mandated reporter statusby neighborhood. The table can be sorted by clicking on the column name or searched using the search box. 
