...
The table below summarizes ACVs by screening decision and race by neighborhood. The table can be sorted by clicking on the column name or searched using the search box. Cells with <5 have been censored for privacy purposes.
...
path <- "/tmp/"
write.csv(d_csv, paste(path,"acv_level_report.csv", sep = ''))
