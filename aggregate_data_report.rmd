---
title: "Aggregated Neighborhood-Level Report"
...
<!-- - This report summarizes `r length(unique(d$PERSON_ID))` ACVs and `r length(unique(d$INTAKE_ID))` intakes with decision dates between `r date_min` and `r date_max`.  -->
